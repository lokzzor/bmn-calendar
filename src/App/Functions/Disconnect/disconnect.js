        ...
        <>
            { props.showModal ? (
                <Spring from={{ opacity: 0, marginTop: -1000 }} to={{ opacity: 1, marginTop: 0 }}>
                    {props4 =>
                        <div style={props4} className="disconnect-background" onClick={closeModal} ref={modalRef}>
                            <div className="disconnect-modalwrapper">
                                <div className="content">
                                    ...
                                    <div className="text">
                                        ...
                                        <p style={{ fontSize: "1.3rem" }}>Technical work on the database is in progress, please wait.</p>
